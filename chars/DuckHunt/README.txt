...
<14.05.2022>
 - Improved compatibility with some characters
 - Adjusted volume of some sound effects

<01.05.2022>
 - Bug fixing
 - Compatibility updates
 - The player can now turn manually by holding back instead of always facing the center of the screen
...
<v.1.2>
 - Fixed bugs
 - When a duck is close to the ground, it now acts as if it were a standing opponent, meaning
...
funnier
 - Lifebars now appear if Duck Hunt has a partner
...
==========< SPECIAL THANKS >==========
 ...
 - BlackJack, for telling me about VS Duck Hunt, from which extra content was ripped
